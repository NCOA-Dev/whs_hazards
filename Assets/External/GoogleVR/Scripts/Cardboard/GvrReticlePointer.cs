...
public class GvrReticlePointer : GvrBasePointer
{
    ...
    public float RETICLE_MIN_OUTER_ANGLE = 0.5f;
    ...
    private bool SetPointerTarget(Vector3 target, bool interactive)
    {
        ...
        if (playerUI)
		{
            playerUI.planeDistance = Mathf.Clamp(ReticleDistanceInMeters * 0.95f, RETICLE_DISTANCE_MIN - 0.1f, maxReticleDistance);
        }
